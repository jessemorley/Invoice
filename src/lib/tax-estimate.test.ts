...
function approx(a: number, b: number, msg: string) {
  expect(Math.abs(a - b), msg).toBeLessThanOrEqual(0.5);
}

describe("tax-estimate", () => {
  it("income tax: bracket boundaries + mid-points", () => {
  ...
  it("HECS: nil below threshold / marginal tiers / whole-income top tier", () => {
