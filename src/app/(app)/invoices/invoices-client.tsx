        ...
        <div className="px-4 md:px-6 py-6 mx-auto w-full max-w-6xl flex flex-col gap-4 flex-1">
          ...
          <Table className="border-separate border-spacing-0">
            <TableHeader className="[&_tr]:border-0">
              <TableRow>
                <SortableTableHead className="w-24 h-9 px-6 bg-transparent dark:bg-input/30 border-y border-input text-xs border-l rounded-l-lg" {...sh("number")}>Number</SortableTableHead>
                <SortableTableHead className="w-28 h-9 px-6 bg-transparent dark:bg-input/30 border-y border-input text-xs" {...sh("issued_date")}>Issued</SortableTableHead>
                <SortableTableHead className="h-9 px-6 bg-transparent dark:bg-input/30 border-y border-input text-xs" {...sh("client")}>Client</SortableTableHead>
                ...
                <SortableTableHead className="w-28 h-9 px-6 bg-transparent dark:bg-input/30 border-y border-input text-xs" align="right" {...sh("total")}>Total</SortableTableHead>
                <SortableTableHead className="w-24 h-9 px-6 bg-transparent dark:bg-input/30 border-y border-input text-xs border-r rounded-r-lg" align="right" {...sh("status")}>Status</SortableTableHead>
              </TableRow>
            </TableHeader>
